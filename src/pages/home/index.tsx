  ...
  <div className="home-page">
    ...
    <div className="introduction-section">
      ...
      <div className="intro-text">
        ...
        <p>
          Kim Hair Salon tự hào là chuỗi salon chuyên gia, có uy tín trong ngành
          làm đẹp tại Việt Nam. Tóc đẹp mỗi ngày là lời cam kết của Kim Hair
          Salon với khách hàng và vẻ đẹp nghệ thuật không chỉ nằm ở sự hào
          nhoáng của vẻ ngoài, mà còn nằm ở tiêu chuẩn “vàng” của mỗi nhà sáng
          tạo. Một mái tóc đẹp, ngoài màu sắc xu hướng, kiểu dáng hợp thời trang
          mà còn phải toát lên nét đẹp từ sự khỏe mạnh của mái tóc từ bên trong.
        </p>
      </div>
    </div>
